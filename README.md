...
The goal of this project is to create a map of the regions of England and show how they are increasing or decreasing in alcohol-specific hospital admissions over time.
